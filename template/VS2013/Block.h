...
class Block
{
	...
	std::array<Drawable, 4> m_buildings;	// The four buildings
	std::vector<glm::vec3> m_boundingBoxes;	// The coordinates of the bounding box (prism).
...
public:
	...
	// Returns the vector of bounding boxes.
